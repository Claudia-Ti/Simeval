          ...
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12 col-md-12 col-lg-12">
                <form action="{{route('monitoringStoreBulk')}}" method="POST">
                    @csrf
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a href="{{url('monitoring_report/create')}}" class="btn btn-info">Back</a>
                      ...
                      <table class="table table-bordered table-striped table-md data-table">
                       ...
                       @foreach($data as $d)
                            <tr>
                                ...
                                <td style="padding-top:20px"><label>{{$d->mc_name}}</label></td>
                                <td>
                                    ...
                                    @endif
                                    <input type="hidden" value="{{$d["id_monitoring"]??'-'}}" name="id_monitoring[]"/>
                                </td>
                                <td>
