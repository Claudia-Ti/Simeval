        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <form method="post" action="{{route('monitoring_criteria.update',$data->id)}}">
                        @csrf
                        @method('put')
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="mc_name" id="name" class="form-control phone-number" value="{{$data->mc_name}}">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="description" id="name" class="form-control phone-number" value="{{$data->description}}">
                                    </div>
