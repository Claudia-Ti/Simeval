        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <form method="post" action="{{route('monitoring_criteria.store')}}">
                        @csrf
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="id_officer" class="form-control">
                                            ...
                                            <option value="{{$p->id}}">{{$p->o_name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="mc_name" id="name" class="form-control phone-number">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="description" id="name" class="form-control phone-number">
                                    </div>
