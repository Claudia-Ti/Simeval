        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <form method="post" action="{{route('performance_report.store')}}">
                        @csrf
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="id_period" id="id_period" class="form-control" onchange="javascript:getCriteria(this.value)">
                                            @foreach($period as $p)
