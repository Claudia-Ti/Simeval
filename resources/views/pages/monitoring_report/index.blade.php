                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            @if($user->level!="Admin" )
                            <a href="{{url('/monitoring_report/create')}}" class="btn btn-primary"><i
                        ...
                        <div class="card-body">
                            ...
                            <div class="filter">
                                <div class="collapse" id="collapseExample">
                                    ...
                                    <form action="{{url('monitoring_report_filter')}}" method="POST">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-md data-table">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:10%;">
                                            @if($user->level=='Kasat')
                                            <form method="post" action="{{url('monitoring_report',$d->id)}}">
                                            @endif
                                                <a href='{{url("/monitoring_report/".$d->id."/edit")}}'
                                        ...
                                        @endif
                                        <td>{{$d->officer_name}} : {{$d->position}} : {{$d->unit}}</td>
                                        <td>{{$d->mon_criteria}}</td>
                                        <td>{{$d->period}}</td>
                                        <td align="right">{{$d->mon_value}}</td>
                                        <td>{{$d->notes}}</td>
