              ...
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  <div class="card-header">
                    @if($user->level=='Admin')
                  <a href="{{url('/criteria/create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>&nbsp;
                  @endif
                    <h4>{{$pageName}}</h4>
                    <div class="card-header-action">
                        
                      @php $filter = session('filter-criteria');@endphp
                            <div class="card-header-action">
                  ...
                  <div class="card-body">
                      ...
                      <div class="filter">
                        <div class="collapse" id="collapseExample">
                            ...
                            <form action="{{url('criteria_filter')}}" method="POST">
                      ...
                      <table class="table table-bordered table-striped table-md data-table">
                       ...
                       @foreach($data as $d)
                            <tr>
                                ...
                                @if($user->level=='Admin')
                                <td style="width:10%;">
                                    <form method="post" action="{{url('criteria',$d->id)}}">
                                        <a href='{{url("/criteria/".$d->id."/edit")}}' class="btn btn-warning"><i class="fa fa-edit"></i></a>
