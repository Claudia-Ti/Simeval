        ...
        <section class="section" >
            <div class="container " style="margin-top: 250px;">
                <div class="row">
                    ...
                    <div class="col-12 ">
                        {{-- col-sm-8 offset-sm-2 col-md-8 offset-md-3 col-lg-8 offset-lg-3 col-xl-4 offset-xl-4"> --}}

                        <div class="card card-primary" style="border-radius: 20px">
                            <div class="card-header">
                              <h3 style="width:100%;text-align:center">LOGIN SIMEVAL</h3>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <div class="login-brand">
                                            <img src="{{asset('logo.png')}}" alt="logo" width="250px"
                                               >
                                            <h3>Polres Minahasa</h3>
